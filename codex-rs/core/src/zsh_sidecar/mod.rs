...
pub(crate) const SIDECAREXEC_WRAPPER_SOCKET_ENV_VAR: &str = "CODEX_ZSH_SIDECAR_WRAPPER_SOCKET";
    ...
    pub(crate) async fn execute_shell_request(
        ...
        let exec_start_req = JsonRpcRequest {
            ...
            params: ExecStartParams {
                ...
                approval_reason: req.justification.clone(),
                tty: Some(false),
                cols: None,
                rows: None,
            },
            ...
            if method == METHOD_ZSH_REQUEST_APPROVAL {
                ...
                let decision = session
                    .request_command_approval(
                        turn,
                        call_id.to_string(),
                        req.params.approval_id.clone(),
                        req.params.command.clone(),
                        PathBuf::from(req.params.cwd),
                        req.params.reason.clone(),
                        None,
                        req.params
